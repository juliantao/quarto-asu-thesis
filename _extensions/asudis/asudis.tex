...
\input{$thesis.frontmatter.abstract$}             %<Enter the name of the .tex file containing your
...
\input{$thesis.frontmatter.dedication$}           %<Enter the name of the .tex file containing your
...
\input{$thesis.frontmatter.acknowledgments$}      %<Enter the name of the .tex file containing your
...
$for(thesis.backmatter.appendices)$
\input{$thesis.backmatter.appendices$}
$endfor$
